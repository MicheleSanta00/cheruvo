 ...
 * Riceve content + onContent; aggiorna il contenuto in modo immutabile.
 */
...
export default function LessonForm({ type, content, onContent, lang, s, onAI, aiBusy }) {
  ...
  if (type === 'quiz') {
    return (
      <div>
        <div style={aiBox}>
          <input style={{ ...inp, flex: '1 1 160px' }} placeholder={s.aiTopic} value={topic} onChange={(e) => setTopic(e.target.value)} />
